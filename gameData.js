...
const defaultGameData = {
    boards: [
        {
            "categories": ['Better known by one name', 'It is slang-tastic', 'Brand Names', 'V-ocabulary', 'Literary Significant Others'],
            [
                {
                  points: 200,
                ...
                {
                  points: 400,
                  question: "Born Stefani Joanne Angelina Germanotta, this artist is known for hits like 'Bad Romance'",
                  answer: "Who is Lady Gaga?",
                  revealed: false
                },
                {
                  points: 600,
                  question: "This 'Material Girl' singer's real name is Madonna Louise Ciccone",
                  answer: "Who is Madonna?",
                  revealed: false
                },
                {
                  points: 800,
                  question: "Born Eric Arthur Blair, this author wrote '1984' and 'Animal Farm'",
  ...
  [
    ...
    {
      points: 1000,
      question: "This luxury car brand's logo features four interlocking rings",
      answer: "What is Audi?",
      revealed: false
    }
  ],
  ...
  [
    ...
    },
    {
      ...
      answer: "What is a sonnet? (Wait, that doesn't start with V... What is verse?)",
      revealed: false
    },
    {
      points: 600,
  ...
  [
    ...
    {
      points: 400,
      question: "Elizabeth Bennet's eventual husband in 'Pride and Prejudice'",
    ...
    {
      points: 800,
      question: "This woman drives Gatsby's obsession in Fitzgerald's novel",
      answer: "Who is Daisy Buchanan?",
      revealed: false
    },
    {
      points: 1000,
      question: "Odysseus's faithful wife who waits 20 years for his return",
